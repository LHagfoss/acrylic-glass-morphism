...
export default function AcrylicBoxes() {
    ...
    return (
        <div className="w-full flex justify-center items-center p-5 md:px-52 relative inset-0">
            <motion.div 
            ...
            <div className="container h-full grid grid-rows-2 grid-cols-2 gap-4">
                <div className="w-full aspect-square backdrop-blur-[200px] p-3 rounded-3xl overflow-hidden bg-[#00000059] border-4 border-[#4c4c4c32]"></div>
                <div className="w-full aspect-square backdrop-blur-[200px] p-3 rounded-3xl bg-[#00000059] border-4 border-[#4c4c4c32] overflow-y-scroll">
                    <VideoList />
                </div>
                <div className="w-full aspect-square backdrop-blur-[200px] p-3 rounded-3xl overflow-hidden bg-[#00000059] border-4 border-[#4c4c4c32]"></div>
                <div className="w-full aspect-square backdrop-blur-[200px] p-3 rounded-3xl overflow-hidden bg-[#00000059] border-4 border-[#4c4c4c32]"></div>
